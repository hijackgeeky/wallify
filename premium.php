...
$stmt = $pdo->query("SELECT * FROM wallpapers WHERE is_premium = 1 ORDER BY created_at DESC");
...
<head>
    ...
    <title>Premium Wallpapers - WalliFy</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container mt-4">
        ...
        <?php if (empty($premium_wallpapers)): ?>
            <div class="alert alert-info">No premium wallpapers available at the moment.</div>
        <?php else: ?>
